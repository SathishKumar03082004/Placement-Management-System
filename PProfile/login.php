    ...
    <div class="templatemo-flex-row">
      <div class="templatemo-sidebar">
        ...
        <div class="profile-photo-container">
          <img src="images/per.jpg.jpg" alt="Profile Photo" class="img-responsive">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-flex-row flex-content-row">
            <div class="templatemo-content-widget white-bg col-2">
              ...
              <p></p>
              <p>Hello Officer! Have a great day with us! With NEC Account, You can add drives, Send Notifications and View the Eligibility Criteria of Students.</p>
          ...
          <div class="templatemo-flex-row flex-content-row">
              ...
              <div class="templatemo-content-widget white-bg">
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <p>Upcoming Drives Updated By Admin</p>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-1">
              <div class="panel panel-default templatemo-content-widget white-bg no-padding templatemo-overflow-hidden">
                <i class="fa fa-times"></i>
                <div class="panel-heading templatemo-position-relative"><h2 class="text-uppercase">Placement Officer Details</h2></div>
          ...
          <footer class="text-right">
           <p>Copyright &copy; 2018 NEc | Developed by
