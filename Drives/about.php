...
<body>
	...
	<div class="about-bottom">
		<!-- container -->
		<div class="container">
			<h3 class="wow fadeInRight animated" style="visibility: visible;">A New Generation of NEC</h3>
			...
			<div class="team-info">
				...
				<div class="team-grids">
					<div class="col-md-3 team-grid wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
						...
						<h6>Mr.K.G.Srinivasagan</h6>
						<p> HOD IT Department & Placement Dean</p>
					</div>
					<div class="col-md-3 team-grid wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
	...
	<!-- footer -->
		...
		<div class="copyright">
			...
			<div class="container">
              ...
              <a href="http://znumerique.azurewebsites.net" target="_parent">IT BOYZ</a>
					</p>
				</div>
