        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background:black">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand page-scroll" href="https://nec.edu.in/">NATIONAL ENGINEERING COLLEGE </a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a class="page-scroll" href="../HODProfile/login.php">HOD Login</a>
                        </li>
                        <li>
                            <a class="page-scroll" href="../PProfile/index.php">Placement Login</a>
                        </li>
                        <li>
                            <a class="page-scroll" href="../PriProfile/index.php">Principal Login</a>
                        </li>
                    </ul>
        ...
        <div class="footer">
			<div class="container">
				...
				<div class="col-md-3 get_in_touch ftr">
					...
					<p>TUTICIRIN,TAMILNADU, India</p>
					<p>9600338742</p>
					<a href="mailto:ashwin3082003@gmail.com">ashwin3082003@gmail.com</a>
				</div>
